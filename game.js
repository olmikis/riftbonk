(() => {
  ...
  function post15Scales(time=state.time) {
    ...
    const strength=state.difficulty?.rift??1,from=t<900?{health:1,damage:1,spawn:1,speed:1}:t<1200?{health:1.65,damage:1.25,spawn:1.35,speed:1.08}:{health:2.5,damage:1.6,spawn:1.75,speed:1.15},to=t<900?{health:1.65,damage:1.25,spawn:1.35,speed:1.08}:t<1200?{health:2.5,damage:1.6,spawn:1.75,speed:1.15}:{health:3.4,damage:2.15,spawn:1.98,speed:1.27},ramp=t<900?(t-600)/300:t<1200?(t-900)/300:clamp((t-1200)/600,0,1),scaled={};
